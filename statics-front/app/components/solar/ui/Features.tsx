            ...
            <div className="relative flex flex-col items-center justify-center">
              <Orbit
                ...
                orbitingObjects={[
                  ...
                  >
                    <RiFootballFill className="z-10 size-5 text-gray-900" />
                  ...
                  <div
                    ...
                    className="relative flex items-center justify-center"
                  >
                    <RiLineChartFill className="z-10 size-5 text-gray-900" />
                    <div className="absolute size-10 rounded-full bg-white/50 ring-1 shadow-lg ring-black/5"></div>
                    <div className="absolute -top-5 left-4">
                      <div className="flex gap-1">
                  ...
                  <div
                    ...
                    className="relative flex items-center justify-center"
                  >
                    <RiPassportFill className="z-10 size-5 text-gray-900" />
                    <div className="absolute size-10 rounded-full bg-white/50 ring-1 shadow-lg ring-black/5"></div>
                    <div
                      style={{
                        animationDelay: "2s",
